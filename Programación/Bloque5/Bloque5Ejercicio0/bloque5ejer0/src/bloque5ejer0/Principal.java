...
public class Principal {
	...
	public static void main(String[] args) {
		...
		cuenta1.getnCuenta());
		System.out.println("Tipo de interés: " + cuenta1.gettInteres());
		...
		System.out.println("Tipo de interés: " + cuenta2.gettInteres());
		...
		System.out.println("Tipo de interés: " + cuenta3.gettInteres());
